...
vm_count=${vm_count:=1}
cloud_init_script_uri=${script_uri:=https://raw.githubusercontent.com/pelleo/distributed-az-edge-framework/k3s/deployment/bicep/modules/create_cloud_init_input_string_bicep.sh}
